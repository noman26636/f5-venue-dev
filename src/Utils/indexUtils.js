...
export const setDefaultLang = () => {
  ...
  const defaultLang =
    browserLanguage === "da-DK" ? "da" : Constants.defaultLang;
...
export const enum_seatingOptions = ["Seating", "Standing"];
export const enum_sortFieldOptions = ["Reviews", "Price", "Capacity"];
export const enum_sortTypeOptions = ["Lowest", "Highest"];
export const enum_sitepages = {
  about: 1,
  privacy: 2,
  terms: 3,
  contact: 4,
