  ...
  return (
    <footer className="">
              ...
              <div className="list">
                <ul className="list-block contact-list">
                  ...
                  <li>
                    ...
                    <div className="text">
                      250 rue de la Montagne Montreal, QC H7D 7K9
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <Col xl={3} lg={3} md={3} sm={6} xs={12} className="">
            <div className="list">
              ...
              <ul className="list-block">
                ...
                {authState.user ? (
                  <li onClick={() => navigate("/addVenueForm")}>
      ...
      <div className="bottom-section">
        © {new Date().getFullYear()} {translations.EventVenue}.{" "}
        {translations.AllRightsReserved}. V {Constants.appVersion}
      </div>
    </footer>
  );
};
