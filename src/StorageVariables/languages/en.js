export var stringVariables = {
    ...
    EmailSent: "Link to change password has been sent to your email. Open that link to change your password.",
    ...
    Section2Desc1: "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
    Section2Title2: "Connect with the best venue",
    Section2Desc2: "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
    Section2Title3: "Let us help you with the event",
    Section2Desc3: "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
    LookingForVenue: "Looking for a venue?",
    FindFastEasy: "Find fast & easy",
    LookingForVenueDesc: "Whether you're organizing a corporate event or a private party, Venuu has a wide selection of amazing event spaces with pictures and all the information you need. Use the search function to find the perfect place for you. In addition to regular settings, we have many unconventional venues to make your day truly unique!",
    ...
    PlanEventDesc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse cursus consequat tellus at hendrerit.",
    AddVenueDesc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse cursus consequat tellus at hendrerit.",
    ...
    InquiryDesc: "Could I have a proposal for the following event:\n\nNumber of guests:\nTime:\nBudget:\nDescription of event:\n\nThanks!",
    VenueName: "Venue name",
    Company: "Company",
    Name: "Name",
    Optional: "optional",
    SendInquiry: "Send inquiry",
    SendInquiryTerms: "By sending an inquiry, you agree to our <a>Terms and Conditions</a> and <b>Privacy Policy</b>.",
    ...
    WishlistsDesc: "Your wish lists are shown below. You can create new lists here or whenever you find an interesting venue in our search.",
    ...
    WishlistVenueDeleteConfirm: "Are you sure you want to delete this venue from wishlist",
    Share: "Share",
    ...
    ThousandsEventBookers: "Thousands event bookers are using EventVenue searching for venues just like yours, for meetings, parties, weddings, team offsites and much more...",
    ...
    YouHaveFullControl_3: "Select which event type tags you want your venue to appear for",
    YouHaveFullControl_4: "Our digital marketing plans and corporate accounts team help you to target your ideal customers",
    GetStarted: "Get started in 3 easy steps",
    GetStarted_Desc: "We're proud to list thousands of under-utilised, undiscovered venues.",
    GetStartedTitle1: "List your spaces and start marketing",
    GetStartedDesc1: "Add photos and descriptions, set your prices and select your tags, choose your cancellation and deposit policies.",
    GetStartedTitle2: "Confirm your first enquiry",
    GetStartedDesc2: "You'll receive an email notification when you receive your first enquiry. You can reply in email or direct email. ",
    GetStartedTitle3: "Get your search boost",
    GetStartedDesc3: "Respond quickly to your enquiries and confirm your bookings to earn a boost up the search rankings. Feel you belong at the top? Stay boosted on our premium plans",
    //Edit venue
    EditYourVenue: "Edit your venue",
    DeleteVenue: "Delete venue",
    SeeVenue: "See Venue",
    VenueAdded: "Venue has been successfully created",
    VenueUpdated: "Venue has been successfully updated",
    VenueDeleteConfirmation: "Are you sure you want to delete this venue. This action cannot be undone",
    VenueDeleted: "Venue deleted successfully",
    ReasonsToBeCareful: "3 reasons to be careful about filling out the profile:",
    ReasonsToBeCareful_1: "You ensure that your venue is visible in Venus' search function",
    ReasonsToBeCareful_2: "You convince visitors about the suitability of your venues",
    ReasonsToBeCareful_3: "You will receive several relevant inquiries and customers",
    BasicInformation: "Basic information",
    LongDescription: "Long description",
    BriefDescription: "A brief description of this venue that is visible on search engines ",
    ...
    CalendarIntegrationDesc: "Your booking information can be displayed on Venuu if your booking system has an iCal feed (such as Google Calendar and Outlook). This can significantly increase the number of relevant queries.",
    BookingSystem: "Booking system",
    IcalCalendarAddress: "iCal calendar address",
    InstructionsForFindingIcalFeed: "<a>Instructions for finding your iCal feed</a>",
    Max: "Max",
    ...
    DetailedCapacityDesc: "Maximum number of guests at different table formations.",
    Classroom: "Classroom",
    Theater: "Theater",
    ...
    Pricing: "Pricing",
    PricingDesc: "Price information is not binding and can be negotiated individually with each customer. NOTE: Even preliminary pricing information can significantly help event planners. In addition, we have noticed that the venues that openly state their rates have significantly more customers.",
    ...
    AdditionalCostsAndCancellationPolicy: "Additional costs and cancellation policy",
    ReservationFee: "Reservation fee",
    CleaningFee: "Cleaning fee",
    CancellationPolicy: "Cancellation policy",
    UploadPhotosOfVenue: "Upload photos of your venue in good quality",
    Instructions: "Instructions:\n\nFirst add the image you want to show in search results\nAdd floor plan of the room as the last picture, if available.\nYou can organize the images by changing the 'Order' field and saving changes.\nThe pictures follow a ascending order.Negative values ​​are allowed.\nPlease note that pictures with advertisements are not allowed.",
    UploadPhotos: "Upload photos",
    UploadPhotosDesc: "You can also add photos by dragging them here. You can add multiple images at a time.",
    ...
    _3DViews: "3D views",
    _3DViewsDesc: "A 3D view gives the customer a realistic picture of your venue and makes it easier to make a decision on whether or not to book.",
    _3DViewsServices: "We currently support the following services:",
    _3DViewsServices1: "Unrealer: oak <a>http://www.unrealer.com/listings/HZYBa3hMN2w</a>",
    _3DViewsServices2: "Matterport: oak <a>https://my.matterport.com/show/?m=iaVvzwynuzn</a>",
    _3DViewsServices3: "WalkInto: oak <a>https://walkinto.in/tour/bkeICbC62ZZklgLRW0anW</a>",
    _3DViewsServices4: "Skyview / Flycam: oak <a>https://skyview.fi/panorama/5412f085ce66bccc02b95a45</a>",
    _3DViewsServices5: "Google Street View: oak<a>https://www.google.com/maps/embed?pb=!4v1546505902480!...</a>",
    _3DViewsErr: "Some 3D views could not be loaded. Please check that you have entered the correct address.",
    ...
    //Company
    EditCompanyInfomation: "Edit company infomation",
    Users: "Users",
    ...
    SendInvitationDesc: "You can invite a new user to this service by filling in the email address below. The user accesses to manage your venues and company information.",
